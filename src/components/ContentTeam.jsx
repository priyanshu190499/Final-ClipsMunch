...
<section className="py-16 px-4 bg-neutral dark:bg-black text-black dark:text-white transition-colors duration-300">
  ...
  <div className="flex flex-col md:flex-row gap-8  max-w-6xl mx-auto justify-center items-stretch">
    {/* Left Card */}
    <div className="flex-1 flex flex-col gap-12 bg-gradient-to-br from-primary to-secondary text-white p-16 rounded-4xl max-w-xl border border-gray-700">
  ...
  {/* CTA footer */}
  <div className="mt-12 flex  max-w-6xl mx-auto justify-center">
    <div className="bg-secondary w-full text-white text-4xl font-bold px-8 py-4 rounded-full shadow-lg text-center">
